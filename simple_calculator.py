...
def compute_response(variable1,variable2,operation):
  ...
  if operation == 1:
    ...
    print("Subtraction of", variable1 , variable2, "is =", variable1 - variable2, end='\n')
  elif operation == 3:
    print("Division of", variable1 , variable2, "is =", variable1 / variable2, end='\n')
  elif operation == 4:
    print("Multiply of", variable1 , variable2, "is =", variable1 * variable2, end='\n')
  else:
